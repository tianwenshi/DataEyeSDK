...
@implementation NSData (DEGzip)

+ (NSData *)gzipData:(NSData *)pUncompressedData {
    if (!pUncompressedData || [pUncompressedData length] == 0) {
        DELogDebug(@"%s: Error: Can't compress an empty or nil NSData object",__func__);
        return nil;
    }
    ...
    if (initError != Z_OK) {
        ...
        DELogDebug(@"%s:deflateInit2() Error: \"%@\" Message: \"%s\"", __func__, errorMsg, zlibStreamStruct.msg);
        return nil;
    }
